...
export default {
    ...
    async execute(interaction: ChatInputCommandInteraction) {
        ...
        const mainEmbed = new EmbedBuilder()
            .setTitle('Democracy Officer Kravchenko Bot Information')
            ...
            .addFields(
                ...
                },
                {
                    ...
                    value: [
                        ...
                        `**Repository:** [GitHub](https://github.com/bshar1865/DOK-Bot)`
                    ].join('\n')
                },
                {
                    name: 'Credits',
                    value: [
                        ...
                        '**Support:** [Star us on GitHub!](https://github.com/bshar1865/DOK-Bot)'
                    ].join('\n')
                }
            )
            .setColor('#ff9500')
            .setTimestamp()
            .setFooter({ text: 'contact bshar1865 if you need help.' });
